                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{__('messages.Edit Advantages')}}</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                <form id="submitForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="service_ar" id="service_ar" placeholder="Enter Advantages" value="{{$services->service_ar}}" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="service_en" id="service_en" placeholder="Enter Advantages" value="{{$services->service_en}}" type="text">
                                        </div>
                                    </div>
