                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{__('messages.Edit Benifits')}}</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                <form id="submitForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="title_ar" id="title_ar" placeholder="Enter Title" value="{{$benifits->title_ar}}" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="title_en" id="title_en" placeholder="Enter Title" value="{{$benifits->title_en}}" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <div class="mt-3">
                                            ...
                                            <input class="dropify" accept="image/png, image/jpeg, image/jpg, image/svg" id="imageAppended" value="{{$benifits->image}}" data-default-file="{{ asset('uploads/' . $benifits->image) }}" type="file" name="image" >
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submitForm').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('benifits.update' , ['language' => app()->getLocale() , 'id' => request()->id])}}",
                    type:"POST",
                    data:formData,
                    processData: false,
                    contentType: false,
