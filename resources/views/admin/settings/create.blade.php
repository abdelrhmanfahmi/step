                            ...
                            <div class="card-body">
                                <form id="submitForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" id="title_ar" name="title_ar" placeholder="Enter Title_ar">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" id="title_en" name="title_en" placeholder="Enter Title_en">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">{{__('messages.Breif_ar')}}</label>
                                        <div class="col-md-10">
                                            <textarea name="breif_ar" id="breif_ar" dir="rtl" class="form-control" cols="30" rows="10" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="breif_en" id="breif_en" dir="ltr" class="form-control" cols="30" rows="10" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="about_us_ar" id="about_us_ar" dir="rtl" class="form-control" cols="30" rows="10" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="about_us_en" id="about_us_en" dir="ltr" class="form-control" cols="30" rows="10" style="resize: none;"></textarea>
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <div class="mt-3">
                                            <label for="formFile" class="form-label">{{__('messages.Add Image About_Us')}}</label>
                                            <input class="dropify" accept="image/png, image/jpeg, image/jpg, image/svg" id="imageAppended1"  type="file" name="about_us_image" >
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <div class="mt-3">
                                            <label for="formFile" class="form-label">{{__('messages.Add Image WhySteps')}}</label>
                                            <input class="dropify" accept="image/png, image/jpeg, image/jpg, image/svg" id="imageAppended2"  type="file" name="why_steps_image" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="address" id="address" placeholder="Enter Address"  type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="twitter" id="twitter" placeholder="Enter Twitter"  type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="facebook" id="facebook" placeholder="Enter Facebook"  type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="instagram" id="instagram" placeholder="Enter Instagram"  type="text">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submitForm').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('settings.store' , app()->getLocale())}}",
                    type:"POST",
                    data:formData,
                    processData: false,
                    contentType: false,
                    success:function(data){
                        Swal.fire({
                            title: 'لقد تم حفظ إعدادات الموقع بنجاح !',
                        ...
                        $.each(error.responseJSON.errors, function(key,value) {
                            Swal.fire({
                                title: 'هناك خطأ ما عند الحفظ ! <br><br> <div style="color:red;">'+value+'</div>',
                                confirmButtonText: 'تم',
                                icon: 'error'
                            })
                        });
