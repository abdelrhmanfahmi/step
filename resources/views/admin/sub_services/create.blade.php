                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">{{__('messages.Sub_Services')}}</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('messages.Sub_Services')}}</a></li>
                                    <li class="breadcrumb-item active">{{__('messages.Create Sub_Services')}}</li>
                                </ol>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submitForm').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('sub_services.store' , app()->getLocale())}}",
                    type:"POST",
                    data:formData,
                    processData: false,
                    contentType: false,
