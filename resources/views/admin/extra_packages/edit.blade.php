                            ...
                            <div class="card-body">
                                <form id="submitForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="name_ar" id="name_ar" placeholder="Enter Name" value="{{$extra_packages->name_ar}}" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="name_en" id="name_en" placeholder="Enter Name" value="{{$extra_packages->name_en}}" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" name="price" id="price" placeholder="Enter Price" value="{{$extra_packages->price}}" type="text">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submitForm').submit(function(e){
                ...
                $.ajax({
                    url:"{{route('extra_packages.update' , ['language' => app()->getLocale() , 'id' => request()->id])}}",
                    type:"POST",
                    data:formData,
                    processData: false,
                    contentType: false,
